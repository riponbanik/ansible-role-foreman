...
docker run --detach --volume="$PWD":/etc/ansible/roles/role_under_test:rw --hostname foreman.example.com --name $container_id $opts geerlingguy/docker-$distro-ansible:latest $init
